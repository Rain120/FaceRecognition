    ...
    ui(new Ui::Addpeople)
{
    ...
    connect(ui->TakeAPotoBtn,SIGNAL(clicked()),this,SLOT(onTakeapotobtnClicked()),Qt::UniqueConnection);
}
...
{
    std::string face_cascade_name = "./haarcascades/haarcascade_frontalface_alt.xml";
...
void Addpeople::read_csv(const std::__cxx11::string &filename, std::vector<cv::Mat> &images, std::vector<int> &labels)
{
    char separator = ';';
