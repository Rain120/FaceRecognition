...
#include "../../FaceRecognition/addpeople.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Addpeople_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Addpeople_t qt_meta_stringdata_Addpeople = {
    {
QT_MOC_LITERAL(0, 0, 9), // "Addpeople"
QT_MOC_LITERAL(1, 10, 21), // "onTakeapotobtnClicked"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "Addpeople\0onTakeapotobtnClicked\0"
};
...
void Addpeople::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onTakeapotobtnClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Addpeople::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Addpeople.data,
      qt_meta_data_Addpeople,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Addpeople::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Addpeople.stringdata0))
